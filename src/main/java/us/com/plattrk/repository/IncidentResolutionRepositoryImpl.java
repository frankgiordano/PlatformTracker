...
@Repository
public class IncidentResolutionRepositoryImpl implements
	...
	public Set<IncidentResolution> getResolutions() {
		...
		Set<IncidentResolution> incidentResolutions = new HashSet<IncidentResolution>(
				myResult);
	...
	public boolean deleteResolution(Long id) {
		try {
			IncidentResolution incidentResolutions = em.find(
					IncidentResolution.class, id);
	...
	public IncidentResolution getResolution(Long id) {
		IncidentResolution incidentResolution = em.find(
				IncidentResolution.class, id);
	...
	public Set<Status> getStatusList() {
		@SuppressWarnings("unchecked")
		List<Status> myResult = em.createNamedQuery(
				IncidentResolution.FIND_ALL_STATUS).getResultList();
